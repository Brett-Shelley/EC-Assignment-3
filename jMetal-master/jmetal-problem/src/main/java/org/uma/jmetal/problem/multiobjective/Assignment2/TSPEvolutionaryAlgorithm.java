...
public class TSPEvolutionaryAlgorithm
{
    ...
    public double evolutionaryAlgorithmFitness(ArrayList<TSP_Instance> population, ITSPFitnessFunction fitness, ITSPMutation mutator, ITSPCrossover crossover)
    {
        TSP_Instance.setFitnessFunction(fitness);
        ...
        return currentPopulation.get(0).getFitness();
    }
}
